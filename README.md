...
```sh
wget https://cdn.jsdelivr.net/gh/Howardnm/dnspod-shell@old/install.sh && chmod +x install.sh && ./install.sh
```
### 修改myddns.sh配置文件
```sh
...
30 0 * * * wget https://cdn.jsdelivr.net/gh/Howardnm/dnspod-shell@old/install.sh && chmod +x install.sh && ./install.sh
```
